...
$hasil_search = $_POST['search'];
$hasil = "%".$hasil_search."%";
$berita = $conn->query("SELECT * FROM berita WHERE judul LIKE '$hasil'")->fetch_all();
...
<body>
  ...
  ?>
      <div class="blog-post">
        <a href="http://localhost/Chstd_PHP/soccer_news/news.php?berita_id=<?php echo $id; ?>">
